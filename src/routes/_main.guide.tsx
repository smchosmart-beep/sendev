    ...
    <div className="space-y-8">
      ...
      <Section id="posting" icon={LayoutGrid} title="글쓰기와 공지">
        ...
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li><strong>활동기록 – 08 사례집 출력</strong>: 지금까지 쓴 내용을 <strong>A4 지면으로 조판한 사례집</strong>으로 바로 볼 수 있습니다. 표지(프로젝트명·한 줄 소개·대표 이미지·팀원·링크 배지)에 이어 개요, 결과물과 기술 구성, 문제 정의 과정, 개발 기록, 교육적 점검, 안전 점검, 제작자와 라이선스, 팀원 후기, 윤리 설문 지면이 순서대로 이어지고 <strong>비어 있는 항목은 자동으로 빠집니다</strong>. 위쪽 <strong>[인쇄·PDF 저장]</strong> 버튼을 누르면 편집 화면은 빠지고 사례집 지면만 인쇄되며, 인쇄 대화상자에서 <strong>대상을 &lsquo;PDF로 저장&rsquo;</strong>으로 고르고 <strong>배경 그래픽 옵션을 켜면</strong> 색과 표가 그대로 저장됩니다. 관리자는 <strong>관리자 &gt; 활동기록 현황</strong>에서 <strong>[사례집 합본 인쇄]</strong>로 모든 팀의 사례집을 한 번에 출력할 수 있습니다(팀 수가 많으면 지면을 만드는 데 잠시 걸립니다).</li>
