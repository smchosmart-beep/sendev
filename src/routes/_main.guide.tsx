    ...
    <div className="space-y-8">
      ...
      <Section id="posting" icon={LayoutGrid} title="글쓰기와 공지">
        ...
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li><strong>활동기록 – 기록한 사람 칸</strong>: <strong>02 문제 정의 과정 기록</strong>과 <strong>04 개발 과정 자유기록</strong>의 각 줄에는 <strong>기록한 사람</strong> 입력칸이 있습니다. 팀원이 [추가] 버튼으로 새 줄을 만들면 <strong>내 닉네임이 자동으로 채워지며</strong>, 필요하면 다른 이름으로 고치거나 비워 둘 수 있습니다. 다른 표(핵심 기능·사용 흐름 등)에는 이 칸이 나오지 않으며, 예전에 이름을 적어 둔 줄은 <strong>기록한 사람: 이름</strong> 형태로만 보입니다.</li>
