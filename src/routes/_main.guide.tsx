    ...
    <div className="space-y-8">
      ...
      <Section id="posting" icon={LayoutGrid} title="글쓰기와 공지">
        ...
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li><strong>활동기록 – 두 가지 유형(도전형·성장형)</strong>: 활동기록 게시판은 관리자가 <strong>도전형</strong>과 <strong>성장형</strong> 중 하나로 정해 둡니다. <strong>도전형</strong>은 <strong>팀 단위 8단계</strong> 기록이고, <strong>성장형</strong>은 <strong>개인 1인 전용 6단계</strong> 기록입니다. 성장형은 팀원 추가 없이 <strong>작성자 본인과 관리자만</strong> 편집할 수 있으며, 단계는 <strong>01 나의 프로젝트 → 02 문제와 해결 → 03 결과물 → 04 성장과 점검 → 05 README 출력 → 06 사례집 출력</strong>입니다. <strong>01</strong>에서는 프로젝트명·한 줄 소개·주 사용자·문제 영역·결과물 형태를 고르고, <strong>02</strong>에서는 해결하고 싶은 문제와 그 근거, 해결 방법, 기대하는 변화를 적습니다. <strong>03</strong>에서는 배포 주소·완성 상태·사용한 도구와 함께 <strong>핵심 기능(최대 3줄)·사용 흐름(최대 3단계)·대표 이미지 1장</strong>(90도 회전 가능)을 정리합니다. <strong>04</strong>에서는 가장 어려웠던 점과 해결 방법, AI에 맡긴 일과 내가 직접 판단한 일, 개인정보 처리 여부, 중요하게 생각한 윤리 원칙(복수 선택), 실천 약속, 새롭게 할 수 있게 된 것, 다음에 보완할 것을 씁니다. 입력은 <strong>약 1초 뒤 자동 저장</strong>되고, 위쪽 단계 버튼에 <strong>작성 수 / 필수 수</strong> 배지와 완료 체크가 표시됩니다. <strong>05·06</strong>에서는 도전형과 같은 방식으로 README 복사와 A4 사례집 인쇄·PDF 저장을 할 수 있습니다. 관리자는 <strong>관리자 &gt; 활동기록 현황</strong>에서 상단의 <strong>도전형 / 성장형</strong> 탭으로 유형을 나눠 진행률을 확인하고 엑셀로 내려받습니다.</li>
