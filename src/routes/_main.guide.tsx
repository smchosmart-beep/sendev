    ...
    <div className="space-y-8">
      ...
      <Section id="admin" icon={Settings} title="관리자 대시보드 접근">
        ...
        <p>
          ...
          공개 게시판 목록에 노출되지 않으며(직접 링크로는 접근 가능), <strong>폴더를 숨기면 그 안의 하위
          게시판도 함께 숨겨집니다</strong>. 운영 기간에 따라 특정 게시판(예: 입문형·도전형)을 잠시 가렸다가
          다시 노출할 때 사용하세요. 숨겨진 게시판은 관리자 목록에서 <strong>눈 가림 아이콘</strong>과
          "목록에서 숨김" 표시로 구분됩니다.
        </p>
        <p>
