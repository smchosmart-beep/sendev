    ...
    <div className="space-y-8">
      ...
      <Section id="admin" icon={Settings} title="관리자 대시보드 접근">
        ...
        <p>
          ...
          흐름·한계·계획·제작자·문제 정의·개발 과정·교육적 점검 항목 수, 개인 후기 작성 인원 등을
