    ...
    <div className="space-y-8">
      ...
      <Section id="posting" icon={LayoutGrid} title="글쓰기와 공지">
        ...
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li><strong>활동기록 – 관리자 수정</strong>: 팀원이 아니어도 관리자는 기록을 고칠 수 있습니다. 활동기록 위쪽 안내문의 <strong>[관리자로 수정하기]</strong> 버튼을 눌러 <strong>관리자 비밀번호</strong>를 입력하면 <strong>관리자 권한으로 편집 중</strong> 안내가 뜨면서 모든 단계를 수정할 수 있습니다. 비밀번호가 틀리면 편집이 열리지 않으며, 확인한 권한은 <strong>브라우저 탭을 닫으면 사라집니다</strong>.</li>
