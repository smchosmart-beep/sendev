...
```text
[01 나의 프로젝트] [02 문제와 해결] [03 결과물] [04 성장과 점검] [05 README] [06 성장 사례집]
```
...
**05 README** — HTML의 9단 구성(프로젝트 소개 → 해결하려는 문제 → 해결 방법 → 핵심 기능 → 사용 흐름 → 교육적 점검과 성장 → 사용 도구 → 바로 사용하기)을 그대로 출력, 복사 버튼 제공

**06 성장 사례집** — 표지 + 「01 문제와 해결」 + 「02 결과물」 + 「03 성장과 점검」 A4 4쪽 조판, 인쇄·PDF 저장 (도전형 사례집과 같은 인쇄 스타일 재사용)
