    ...
    <div className="space-y-8">
      ...
      <Section id="posting" icon={LayoutGrid} title="글쓰기와 공지">
        ...
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li>글자 색상·굵게·기울임·밑줄은 <strong>서로 겹쳐 써도 모두 정상</strong>으로 적용됩니다. 예전에 작성한 글에서 색이 빠지거나 <code>&lt;/u&gt;</code> 같은 글자가 보이는 등 서식이 깨져 있으면, 그 글을 <strong>편집했다가 다시 저장</strong>하면 정상으로 고쳐집니다.</li>
        </ul>
