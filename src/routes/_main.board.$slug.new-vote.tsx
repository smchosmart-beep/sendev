...
function NewVotePage() {
  const { slug } = useParams({ from: "/_main/board/$slug/new-vote" });
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-card p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          한 명당 한 개만 올릴 수 있어요. 올린 글이 곧 투표 후보가 됩니다.
        </p>
        ...
        >
          ...
          <div className="space-y-2">
            <Label htmlFor="v-author">작성자</Label>
            <Input
              id="v-author"
              value={author}
          ...
          <div className="space-y-2">
            <Label htmlFor="v-nickpw">닉네임 비밀번호</Label>
            <PasswordInput
              id="v-nickpw"
          ...
          {needsConfirm && (
            <div className="space-y-2">
              <Label htmlFor="v-nickpw-confirm">닉네임 비밀번호 확인</Label>
              <PasswordInput
                id="v-nickpw-confirm"
