  ...
  .inputValidator((input) =>
    z
      .object({
        ...
        col1: z.string().max(8000).default(""),
        col2: z.string().max(8000).default(""),
        col3: z.string().max(8000).default(""),
        col4: z.string().max(8000).default(""),
        col5: z.string().max(8000).default(""),
        col6: z.string().max(8000).default(""),
        knownUpdatedAt: z.string().max(40).default(""),
        author: z.string().trim().max(100).default(""),
        nicknamePassword: z.string().trim().max(100).default(""),
        adminPassword: z.string().max(200).default(""),
